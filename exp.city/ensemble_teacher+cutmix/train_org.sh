...
export volna="../../"
export NGPUS=2
export OUTPUT_PATH="../../output_city/city8_res50_cutmix_B4" # CHECK : labeled_ratio
...
CUDA_VISIBLE_DEVICES=$CUDA_VISIBLE_DEVICES python -m torch.distributed.launch --nproc_per_node=2 train_org.py
