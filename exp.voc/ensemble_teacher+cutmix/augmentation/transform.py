...
class Rand_Augment():
    ...
    def randomNoiseGauss(self, image, mask=None):
    ...
    def randomNoisePoisson(self, image, mask=None):
    ...
    def randomTuneBrightness(self, image, mask=None):
    ...
    def randomTuneBrightnessChannel(self, image, mask=None):
    ...
    def randomEqualize(self, image, mask=None):
    ...
    def randomBlur(self, image, mask=None):
    ...
    def randomhsv(self, image, mask=None):
    ...
    def randomCtsGamma(self, image, mask=None):
    ...
    def randomCtsLinear(self, image, mask=None):
    ...
    def randomFlipHorizontal(self, image, mask=None):
    ...
    def randomFlipVerticle(self, image, mask=None):
    ...
    def randomCloud(self, image, mask=None):
    ...
    def randomInvertChannel(self, image, mask=None):
    ...
    def randomChannleShuffle(self, image, mask=None):
    ...
    def randomDropout(self, image, mask=None):
    ...
    def randomCoarseDropout(self, image, mask=None):
    ...
    def randomMultiply(self, image, mask=None):
    ...
    def randomJpegCompression(self, image, mask=None):
    ...
    def randomRotate(self, image, mask=None):
    ...
    def randomShear(self, image, mask=None):
    ...
    def randomTranslate_x(self, image, mask=None):
    ...
    def randomTranslate_y(self, image, mask=None):
        image = self.tune_translate.augment_image(image)
        if mask is not None :
            mask = self.tune_translate.augment_image(mask)
        return image, mask
    ...
    def randomScale(self, image, mask=None):
